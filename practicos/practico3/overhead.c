...
Overhead
========
El siguiente código inicializa una cantidad predeterminada de generadores de
números aleatorios y luego avanza cada uno de ellos, calculando luego el valor
promedio de los números generados por todos.

Sin embargo, la versión paralela del código utilizando OpenMP no mejora la
performance como se espera. Investigue el código y corríjalo para que escale.
